<script lang="ts">
  import type { IProjectCategorized } from "../../data/types";
  import {
    monthNumberToMonth,
  ...
  const timeCaption = timeCaptionGenerator(projectProps);
</script>
...
<main>
  ...
  <div id="project-link-container">
    <div id="project-link">
      <p>See Project</p>
      <i class="fa-solid fa-arrow-up-right-from-square arrow-icon" />
    </div>
  </div>
</main>
